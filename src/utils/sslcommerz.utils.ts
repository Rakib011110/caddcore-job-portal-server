...
import { getSSLCommerzConfig, validateSSLCommerzEnvironment } from '../config/sslcommerz.config';
...
export const initiateSSLCommerzPayment = async (data: PaymentInitiationData) => {
  try {
