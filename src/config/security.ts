  ...
  CORS: {
    origin: process.env.NODE_ENV === 'production'
      ? [
          ...
          'https://jobs.caddcore.net',
          'https://www.jobs.caddcore.net'
        ]
      : ['http://localhost:3000', 'http://localhost:3001', 'https://caddcore-job-portal-client.vercel.app', 'https://jobs.caddcore.net'],
    credentials: true,
...
export class SecurityUtils {
  ...
  static async hashPassword(password: string): Promise<string> {
    ...
    return await bcrypt.hash(password, SECURITY_CONFIG.BCRYPT.SALT_ROUNDS);
  }
  ...
  // Log security events
  static logSecurityEvent(event: string, details: any, req?: any) {
