 ...
 * ];
 */
export declare const HIDDEN_MEMBER_IDS: string[];
/**
 ...
 */
export declare const isHiddenMemberId: (membershipId: string) => boolean;
/**
 * Get all hidden member IDs
 * @returns Array of hidden member IDs
 */
export declare const getHiddenMemberIds: () => string[];
//# sourceMappingURL=hiddenMembers.config.d.ts.map