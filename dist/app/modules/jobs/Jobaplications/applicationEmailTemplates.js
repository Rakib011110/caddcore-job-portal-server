...
exports.ApplicationEmailTemplates = exports.applicationRejectedTemplate = exports.applicationSelectedTemplate = exports.interviewRescheduledTemplate = exports.interviewScheduledTemplate = exports.applicationShortlistedTemplate = exports.applicationReviewedTemplate = exports.applicationReceivedTemplate = void 0;
...
// ─────────────────────────────────────────────────────────────────────────────
const applicationReceivedTemplate = (data) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
    ...
    <div class="content">
      ...
      <div class="info-box" style="border-left-color: #2563eb;">
        ...
        <div class="info-row">
          ...
          <span class="info-value">${(0, timezone_config_1.formatDate)(data.appliedAt)}</span>
        </div>
        <div class="info-row">
...
// ─────────────────────────────────────────────────────────────────────────────
const applicationReviewedTemplate = (data) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
    ...
    <div class="content">
      ...
      <div class="info-box" style="border-left-color: #0891b2;">
        ...
        <div class="info-row">
          ...
          <span class="info-value">${(0, timezone_config_1.formatDate)(data.reviewedAt)}</span>
        </div>
      </div>
...
`;
exports.applicationReviewedTemplate = applicationReviewedTemplate;
// ─────────────────────────────────────────────────────────────────────────────
// TEMPLATE: SHORTLISTED
// ─────────────────────────────────────────────────────────────────────────────
const applicationShortlistedTemplate = (data) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
    ...
    <div class="content">
      ...
      <div class="info-box" style="border-left-color: #059669; background-color: #ecfdf5;">
        ...
        <div class="info-row">
          ...
          <span class="info-value">${(0, timezone_config_1.formatDate)(data.shortlistedAt)}</span>
        </div>
      </div>
...
`;
exports.applicationShortlistedTemplate = applicationShortlistedTemplate;
// ─────────────────────────────────────────────────────────────────────────────
// TEMPLATE: INTERVIEW SCHEDULED
// ─────────────────────────────────────────────────────────────────────────────
const interviewScheduledTemplate = (data) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="info-box" style="border-left-color: #7c3aed; background-color: #f5f3ff;">
        <div class="info-row">
          <span class="info-label">📅 Date</span>
          <span class="info-value">${(0, timezone_config_1.formatDate)(data.interviewDate)}</span>
        </div>
        <div class="info-row">
...
// ─────────────────────────────────────────────────────────────────────────────
const interviewRescheduledTemplate = (data) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
    ...
    <div class="content">
      ...
      <div style="display: flex; gap: 16px; margin: 24px 0;">
        <div style="flex: 1; background-color: #fef2f2; border-radius: 8px; padding: 16px; text-decoration: line-through; opacity: 0.7;">
          ...
          <p style="margin: 0; font-size: 14px; color: #7f1d1d;">${(0, timezone_config_1.formatDate)(data.previousDate)}</p>
        ...
        <div style="flex: 1; background-color: #ecfdf5; border-radius: 8px; padding: 16px; border: 2px solid #10b981;">
          ...
          <p style="margin: 0; font-size: 14px; color: #065f46; font-weight: 600;">${(0, timezone_config_1.formatDate)(data.newDate)}</p>
...
`;
exports.interviewRescheduledTemplate = interviewRescheduledTemplate;
// ─────────────────────────────────────────────────────────────────────────────
// TEMPLATE: SELECTED / OFFER
// ─────────────────────────────────────────────────────────────────────────────
const applicationSelectedTemplate = (data) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
      ...
      <div class="info-box" style="border-left-color: #16a34a; background-color: #f0fdf4;">
        ...
        ${data.joiningDate ? `
          <div class="info-row">
            ...
            <span class="info-value">${(0, timezone_config_1.formatDate)(data.joiningDate)}</span>
          </div>
        ` : ''}
      </div>
...
`;
exports.applicationSelectedTemplate = applicationSelectedTemplate;
// ─────────────────────────────────────────────────────────────────────────────
// TEMPLATE: REJECTED
// ─────────────────────────────────────────────────────────────────────────────
const applicationRejectedTemplate = (data) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
`;
exports.applicationRejectedTemplate = applicationRejectedTemplate;
// ─────────────────────────────────────────────────────────────────────────────
// EXPORT ALL TEMPLATES
// ─────────────────────────────────────────────────────────────────────────────
exports.ApplicationEmailTemplates = {
    applicationReceived: exports.applicationReceivedTemplate,
    applicationReviewed: exports.applicationReviewedTemplate,
    applicationShortlisted: exports.applicationShortlistedTemplate,
    interviewScheduled: exports.interviewScheduledTemplate,
    interviewRescheduled: exports.interviewRescheduledTemplate,
    applicationSelected: exports.applicationSelectedTemplate,
    applicationRejected: exports.applicationRejectedTemplate,
};
//# sourceMappingURL=applicationEmailTemplates.js.map