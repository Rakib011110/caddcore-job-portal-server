...
const interviewScheduleSchema = new mongoose_1.Schema({
    ...
    rescheduleHistory: [{
            ...
            rescheduledBy: { type: mongoose_1.Schema.Types.ObjectId, ref: "User" },
...
// ─────────────────────────────────────────────────────────────────────────────
const offerDetailsSchema = new mongoose_1.Schema({
    salary: { type: Number },
 ...
 */
const placementRecordSchema = new mongoose_1.Schema({
...
//# sourceMappingURL=Jobaplications.model.js.map