...
const deletedBySchema = new mongoose_1.Schema({
    userId: {
        type: mongoose_1.Schema.Types.ObjectId,
        ref: 'User',
        required: true
...
const archivedBySchema = new mongoose_1.Schema({
    userId: {
        type: mongoose_1.Schema.Types.ObjectId,
        ref: 'User',
        required: true
...
const conversationSchema = new mongoose_1.Schema({
    ...
    type: {
        type: String,
        enum: Object.values(chat_constant_1.CONVERSATION_TYPE),
        default: chat_constant_1.CONVERSATION_TYPE.PRIVATE,
    },
    // ═══════════════════════════════════════════════════════════════════════════
 ...
 */
conversationSchema.statics.findExistingConversation = async function (userId1, userId2) {
 ...
 */
conversationSchema.statics.isParticipant = async function (conversationId, userId) {
...
conversationSchema.pre('save', function (next) {
    if (this.type === chat_constant_1.CONVERSATION_TYPE.PRIVATE && this.participants.length === 2) {
