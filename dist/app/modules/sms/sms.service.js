...
const sendSMS = async (phoneNumber, message) => {
    try {
        ...
        // Prepare API URL
        const apiUrl = `${config_1.default.bulk_sms_base_url}/smsapi`;
        // API parameters (don't encode message here, axios will handle it)
        const params = {
            api_key: config_1.default.bulk_sms_api_key,
            type: 'text',
            number: formattedNumber,
            senderid: config_1.default.bulk_sms_sender_id,
...
const checkBalance = async () => {
    try {
        const apiUrl = `${config_1.default.bulk_sms_base_url}/getBalanceApi`;
        const params = {
            api_key: config_1.default.bulk_sms_api_key
        };
        const response = await axios_1.default.get(apiUrl, { params });
