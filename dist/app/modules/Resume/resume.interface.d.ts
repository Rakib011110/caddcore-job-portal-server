...
import { IAward, ICertification, IEducation, ILanguage, IProject, IReference, ISkill, ISocialLinks, IWorkExperience } from '../User/user.interface';
...
export interface IResumeEligibility {
    ...
    reason?: string;
    counts: Record<TResumeStatus, number> & {
        total: number;
    };
}
...
//# sourceMappingURL=resume.interface.d.ts.map